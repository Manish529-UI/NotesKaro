...
function Footer() {
        ...
        >
          <div className="flex items-center gap-3 cursor-pointer"
            ...
            style={{ textShadow: "0 6px 18px rgba(0,0,0,0.4)" }}>
              NotesKaro <span className="text-gray-400"></span>
            </span>
          </div>

          <p className="text-sm text-gray-300 max-w-sm">
            NotesKaro empowers learners to automatically generate high-quality study guides, structured assignment docs, visual flowcharts, and instant printable PDFs powered by AI.
          </p>
 ...
 <div className='text-center'>
  ...
  <ul className='space-y-2 text-sm'>
    ...
    <li onClick={handleSignOut} className='text-red-400 hover:text-red-300 transition-colors cursor-pointer'>SignOut</li>
    <li className='text-gray-300 hover:text-white transition-colors cursor-pointer'>Support@noteskaro.com</li>
  </ul>
</div>


      </div> {/* 👈 Ye closing tag missing tha */}
<div className="my-6 h-px bg-white/10" />
<p className='text-center text-xs text-gray-500'>
  © {new Date().getFullYear()} NotesKaro. All rights reserved.
</p>
