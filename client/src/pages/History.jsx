    ...
    <div className='min-h-screen bg-gradient-to-br from-gray-100 to-gray-200 px-6 py-8'>
      ...
      <motion.header
        ...
        className="
                ...
                flex justify-between md:items-center gap-4 flex-wrap-col
      ...
      >
        ...
        <div className='flex items-center gap-4 flex-wrap'>
         ...
         {!isSideBarOpen && <button onClick={() => setIsSideBarOpen(true)} className='text-white text-2xl cursor-pointer'>
            <GiHamburgerMenu />
          </button> }
...
className='fixed lg:static top-0 left-0 z-50 lg:z-auto w-72 lg:w-auto h-full lg:h-[75vh] lg:rounded-3xl
lg:col-span-1 bg-black/90 lg:bg-black/80 backdrop-blur-xl border border-white/10 shadow-[0_20px_45px_rgba(0,0,0,0.6)] p-5 overflow-y-auto'
>
