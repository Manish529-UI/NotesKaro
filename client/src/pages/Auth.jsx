...
function Auth() {
  ...
  return (
    <div className='min-h-screen overflow-hidden bg-white text-black px-8'>
      ...
      >
        {/* 🛑 FIX 2: bg-linear-to-r ko bg-gradient-to-r kiya */}
       <h1 className='flex items-center gap-2 text-2xl font-bold bg-gradient-to-r from-white via-gray-300 to-white bg-clip-text text-transparent'>

  <img src={logo} alt="NotesKaro" className="w-9 h-9 shrink-0" />
  <span className="bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-500 bg-clip-text text-transparent">NotesKaro</span>

<span className="text-1.7xl font-semibold text-white ml-1 drop-shadow-[0_0_8px_rgba(168,85,247,0.5)]">
            </span>
</h1>
      ...
      <main className='max-w-7xl mx-auto py-10 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center'>
        ...
        >
          ...
          <motion.button
            ...
            className='mt-10 px-10 py-3 rounded-xl flex items-center gap-3 bg-gradient-to-br from-black/90 via-black/80 to-black/90 border border-white/10 text-white font-semibold text-lg shadow-[0_25px_60px_rgba(0,0,0,0.7)] cursor-pointer'
          >
            <FcGoogle size={22} />
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 gap-8'>
          <Feature
            ...
            des="Start with 50 free credits to create exam notes without paying."
          />
          <Feature 
            icon="📘" 
            title="Exam Notes" 
